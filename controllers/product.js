...
//list categories that are used in product model eg:maybe only 2 categories are used while creating products
  ...
  for (let key in req.body.filters) {
    if (req.body.filters[key].length > 0) {
      if (key === 'price') {
        ...
        // lte - less than
        findArgs[key] = {
          $gte: req.body.filters[key][0], //$gte,$lte - inbuilt mongo db keys
...
/**
 * Retriveing photo of a product as middleware
 */
